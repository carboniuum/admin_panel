<template>
    ...
    <div>
        <form class="form-signin" @submit.prevent="submit">
            ...
            <input type="text" id="firstName" class="form-control" placeholder="First Name" required v-model="firstName" />
            ...
            <label for="passwordConfirm" class="sr-only">Repeat password</label>
